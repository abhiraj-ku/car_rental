        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Experience the freedom of the open road with our premium car rental service. Find the perfect vehicle for your needs.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/login" className="text-gray-300 hover:text-white transition duration-200">Login</a></li>
              <li><a href="/register" className="text-gray-300 hover:text-white transition duration-200">Register</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition duration-200">About Us</a></li>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start">
                ...
                <span className="text-gray-300">123 Car Street, Auto City, AC 12345</span>
              </div>
